...
export const initialData: SeedData = {
    users: [
        { email: 'jortiz@example.com', password: bcrypt.hashSync('123456'), name: 'Jean', role: 'admin' },
        { email: 'dperez@example.com', password: bcrypt.hashSync('123456'), name: 'Dolly', role: 'user' },
    ],
